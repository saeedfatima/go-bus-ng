...
import { Clock, MapPin, Users, Wifi, Plug, Cookie, CheckCircle, Star } from 'lucide-react';
      ...
      <div className="p-6">
        <div className="flex flex-col lg:flex-row lg:items-center gap-6">
          ...
          <div className="flex items-center gap-3 lg:w-48">
            <div className="text-3xl">{trip.company.logo}</div>
            <div>
              <div className="flex items-center gap-1">
                <h3 className="font-semibold text-foreground">{trip.company.name}</h3>
          ...
          <div className="flex-1">
            <div className="flex items-center gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">{trip.route.origin.name}</p>
              </div>
              ...
              <div className="flex-1 flex items-center gap-2">
                ...
                <div className="flex items-center gap-1 text-xs text-muted-foreground bg-muted px-2 py-1 rounded-full">
                  ...
                  <span>{trip.route.durationHours}h</span>
                </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">{trip.route.destination.name}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 lg:flex-col lg:items-end lg:gap-2">
            <div className="text-right">
              <p className="font-display text-2xl font-bold text-primary">{formatPrice(trip.price)}</p>
        ...
        <div className="flex flex-wrap items-center gap-4 mt-4 pt-4 border-t border-border">
          ...
          <span className={cn(
            ...
            busTypeStyles[trip.bus.busType]
          )}>
            {trip.bus.busType}
          </span>
