...
import { User, Phone, Lock, Eye, EyeOff, Save, Loader2 } from 'lucide-react';
...
const Profile = () => {
  ...
  const updateProfileMutation = useMutation({
    mutationFn: async (data: { fullName: string; phone: string }) => {
      ...
      return await api.profiles.update(user.id, data);
    },
    onSuccess: () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-8 px-4 bg-gradient-hero">
